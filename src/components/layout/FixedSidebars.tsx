...
const navItems = [
  ...
  { id: "usage", label: "HOW TO USE", href: "#usage" },
  { id: "lineup", label: "LINE UP", href: "#lineup" },
];

/**
 * PC向け左右固定装飾エリア
 * - 左: ブランドロゴ、SNSリンク、フッターリンク
 * - 右: ナビゲーションメニュー（スクロール連動）、購入ボタン
 */
export function FixedSidebars() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ["lineup", "usage", "points", "concept"];
  ...
  return (
    <>
      ...
      >
        ...
        <div className="fixed-sidebar-content justify-between py-8 relative z-10">
          {/* ブランドロゴ */}
